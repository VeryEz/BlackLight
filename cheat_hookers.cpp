...
hk_PlCol_proceed_w_Veh:
	...
	{
		if (BlackLightFuncs->bVehicleTrailerSupport && PlayerCollision_edi_back == (DWORD)((vehicle_info *)PlayerCollision_tmp)->trailer )
			goto hk_PlCol_noCol;
	}
	else if ( PlayerCollision_edi_back == PlayerCollision_tmp )
	{
		if (BlackLightFuncs->bVehicleTrailerSupport && PlayerCollision_esi_back == (DWORD)((vehicle_info *)PlayerCollision_tmp)->trailer )
			goto hk_PlCol_noCol;
	}
	else if (BlackLightFuncs->bVehicleTrailerSupport && ((DWORD)((vehicle_info*)PlayerCollision_tmp)->trailer == PlayerCollision_esi_back
	...
	if ( !BlackLightFuncs->bObjectsNoCollision)
		goto hk_PlCol_processCol;
...
void _declspec ( naked ) HOOK_RenderEntity ()
{
	...
	if ( !BlackLightFuncs->bObjectsNoCollision || cheat_state->_generic.cheat_panic_enabled
		|| BlackLightFuncs->bVehicleFly)
		goto hk_RE_draw;
