...
struct stNewFunctions //dont use string in here
{
	struct stMenu
	{
		...
		bool bImScoreboad;
		bool bImSAMPAudioStream;
		bool bImVehRecording;
...
public:
	...
	bool IsCurrentServer(const char* szIp = "51.254.85.134:7776");
