...
extern class RakClient2 *g_RakClient2;
...
class RakClientInterface2
{
public:
	virtual ~RakClientInterface2() {};
...
{
public:
	RakClient2(void *pRakClientInterface);
	...
	void SendVehicleDamageComponents(int vehicleID);

	RakClientInterface2 *GetInterface(void) { return pRakClient; };

private:
	RakClientInterface2 *pRakClient;
};